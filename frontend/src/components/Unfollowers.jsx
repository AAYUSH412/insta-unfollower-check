...
const Unfollowers = () => {
  ...
  const getTabContent = () => {
    ...
    const { title, data, color } = tabData[activeTab];
  ...
  return (
    <div className="max-w-4xl mx-auto px-2 sm:px-4 py-6 sm:py-12">
      <div className="glass-effect rounded-xl shadow-xl p-4 sm:p-8">
        {!results ? (
          <>
            <h1 className="text-2xl sm:text-4xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 mb-6 sm:mb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                  ...
                  <div className="flex items-center space-x-4">
                    {!followersFile ? (
                      <div className="flex-1">
                        <label className="flex justify-center items-center px-4 sm:px-6 py-3 sm:py-4 border-2 border-gray-700 border-dashed rounded-lg cursor-pointer hover:border-purple-500 transition-colors">
                          ...
                          <div className="flex items-center space-x-2">
                            <UploadIcon className="w-5 h-5 sm:w-6 sm:h-6 text-gray-400" />
                      ...
                      <div className="flex-1 flex items-center justify-between p-3 sm:p-4 bg-purple-900/20 rounded-lg">
                        <div className="flex items-center space-x-2 sm:space-x-3">
                          <FileJson className="w-5 h-5 sm:w-6 sm:h-6 text-purple-400" />
              ...
              >
                {loading ? (
                  <div className="flex items-center space-x-2">
                    <span className="animate-spin rounded-full h-4 w-4 sm:h-5 sm:w-5 border-2 border-b-0 border-white"></span>
            ...
            <div className="mt-6 sm:mt-8 p-4 sm:p-6 glass-effect rounded-lg border border-gray-800">
              ...
              <ul className="list-disc list-inside space-y-2 text-xs sm:text-sm text-gray-400">
                <li>Make sure to upload both JSON files</li>
                <li>Files should be named correctly</li>
                <li>Data is processed locally only</li>
              </ul>
            </div>
          </>
        ) : (
        ...
        {error && (
          <div className="mt-4 p-3 sm:p-4 bg-red-900/20 border border-red-900 rounded-lg">
